...
class savanna::dashboard ($savanna_host = '127.0.0.1', $savanna_port = '8386', $use_neutron = false,) {
  ...
  # replace with this at the end of the file
  # HORIZON_CONFIG['dashboards'] += ('savanna',)
